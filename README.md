...
```bash
curl -fsSL https://github.com/tokenlive/tokenlive-standalone/releases/download/v0.9.1/tokenlive-0.9.1-linux-services.tar.gz | tar -xz
sudo bin/install-linux.sh 0.9.1
# http://127.0.0.1:2525  —  admin / admin
```
