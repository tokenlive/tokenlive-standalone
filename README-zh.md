...
```bash
curl -fsSL https://github.com/tokenlive/tokenlive-standalone/releases/download/v0.7.0/tokenlive-0.7.0-linux-services.tar.gz | tar -xz
sudo bin/install-linux.sh 0.7.0
# http://127.0.0.1:2525  —  admin / admin
```
